...
const MergeCrashModalLayout =({isOpen, onClose, crashData}) => {
            ...
            <div className={styles.modalOverlay}>
                <div className={styles.mergemodal}>
                    ...
                    <div className={styles.madalLayout}>
                        <MergeCrashTableUI data={crashData} onSelect={handleSelectIndex}/>

                        {crashData.map((item, index) => (
                            <MargeCrashChartUI key={index} data={item} index={index} selectedIndex={selectedIndex}/>
                        ))}
                    </div>
